		       ...
		       int flags)
{
	...
	/* DaisyForGaming: loader-friendly kernel - accept .ko built for any
	 * kernel version (plain insmod behaves like insmod -f).
	 * vermagic + symbol CRC checks are skipped; unknown symbols still
	 * fail the load, so broken modules can't crash the kernel here. */
