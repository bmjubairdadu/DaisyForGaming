...
Get the flashable zip from [Releases](https://github.com/bmjubairdadu/DaisyForGaming/releases) — `DaisyForGaming-v1.1-Gaming-4.9.337-*-AnyKernel3.zip`. Flash with TWRP / OrangeFox.
