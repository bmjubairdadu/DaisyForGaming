...
# Project owner - helper repos are cloned from this GitHub account
# Change it to your own GitHub username if you forked the repos
...
if [[ "$OS" == *"SUSE"* ]] || [[ "$OS" == *"Regata"* ]]; then
    ...
    if [[ ! -d "$AKHILNARANG" ]]; then
        ...
        git clone --depth=1 https://github.com/${GH_USER}/scripts -b akh ${AKHILNARANG}
